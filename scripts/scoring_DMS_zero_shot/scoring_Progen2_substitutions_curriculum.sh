...
export output_scores_folder="${DMS_output_score_folder_subs}Progen2/${experiment_category}-${run_name}"
run_timestamp=$(date +"%Y_%m_%d_%H_%M_%S")
export log_folder="../../logs/DMS_zero_shot_substitutions/Progen2/${experiment_category}-${run_name}-${run_timestamp}"
